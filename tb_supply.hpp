	...
	staticWeapons[] = {"RDS_M2StaticMG_MiniTripod_FIA", "RDS_M2StaticMG_FIA", "RDS_KORD_high_CSAT", "RDS_KORD_CSAT", "RDS_DSHKM_CSAT", "RDS_DSHkM_Mini_TriPod_CSAT", "RDS_M252_FIA", "RDS_2b14_82mm_CSAT", "RDS_TOW_TriPod_FIA", "RDS_Metis_CSAT", "RDS_SPG9_CSAT", "RDS_D30_CSAT", "RDS_ZU23_CSAT", "RDS_M119_FIA"};
		...
		class CargoCollections
		{
			...
			class statics_west {
				transportClear = 1;
				cargo[] = {
					{"RDS_M2StaticMG_MiniTripod_FIA", 5, 20},
					{"RDS_M2StaticMG_FIA", 5, 20},
					{"RDS_TOW_TriPod_FIA", 2, 8},
					{"TB_Box_West_Mines_F", 8, 0},
					{"RDS_M252_FIA",2, 30},
					{"ICE_emptySandbagsCrate_supply", 0,0}
				};
			};
			...
			class statics_east {
				...
				cargo[] = {
					{"RDS_KORD_CSAT", 5, 20},
					{"RDS_KORD_high_CSAT", 5, 20},
					{"RDS_Metis_CSAT", 2, 4},
					{"RDS_2b14_82mm_CSAT", 2, 30},
			...
			class rds_westFO {
				transportClear = 1;
				cargo[] = {
					{"RDS_M2StaticMG_FIA", 2, 5},
					{"RDS_M2StaticMG_MiniTripod_FIA", 2, 5},
					{"RDS_TOW_TriPod_FIA", 1, 3},
